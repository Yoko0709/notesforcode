...
Initialize prev = None and cur = head.
...
where 1 ≤ left ≤ right ≤ n, reverse the nodes of the list from position left to right,
...
Left Segment — nodes before left

Middle Segment — nodes between [left, right] (to reverse)

Right Segment — nodes after right
